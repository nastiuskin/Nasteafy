...
namespace Nasteafy.Application.Tracks.Queries.GetAll
{
    public record GetAllTracksQuery(PagedRequest PagedRequest)
      ...
      : IRequestHandler<GetTracksByAlbumIdQuery, Result<PagedResult<GetTrackDto>>>
    {
        ...
        {
            var tracks = await unitOfWork.Tracks.GetPagedResultAsync(request.PagedRequest, ct);
